...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"data save failed";
			// 
			// label2
			// 
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(114, 70);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(49, 23);
			this->button2->TabIndex = 3;
			this->button2->Text = L"ok";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &rewrite_arr_file_warn::button2_Click);
			// 
			// rewrite_arr_file_warn
			// 
